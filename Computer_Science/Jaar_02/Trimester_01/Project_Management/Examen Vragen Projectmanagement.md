Je mag boek gebruiken en ook (Op Examen) -> Notities in boek!!!!!
...
- **Testtypes**:
    ...
    - **Cross-platform testen**: Evaluatie van de werking op verschillende platformen.
    - **Performantietesten**: Beoordeling van snelheid, vooral onder piekbelasting.
...
- **Deliverables**:
    - **Testplan**: Bevat de teststrategie en testscenario’s:
        ...
        - Testdata: Relevante gegevens voor een realistische testomgeving.
        - Verantwoordelijkheden en planning: Rollen en timing van testers.
...
- **Aandachtspunten**:
    ...
    - **Geautomatiseerde tests**: Herbruikbare testtools verlagen de kosten, maar vereisen initiële investering.
    - **Tijdsbegroting**: Rekening houden met onverwachte bugs en pessimistisch plannen.
...
- **Rollen en Verantwoordelijkheden**:
    ...
    - **Trainers**: Verzorgen van training voor eindgebruikers.

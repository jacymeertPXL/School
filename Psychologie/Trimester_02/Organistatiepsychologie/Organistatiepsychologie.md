# Module 01: Inleiding tot de Organisatiepsychologie
...
# Module 03: Leren in Organisaties
...
**1.2 Operante conditionering (Skinner)**

- Leren door beloning of straf.
- Gedrag wordt herhaald als het wordt beloond (positieve bekrachtiging) of vermeden als het wordt gestraft.
- Voorbeeld: Een werknemer werkt over en krijgt een compliment, waardoor hij vaker overwerkt.

**1.3 Observationeel leren (Bandura)**

- Leren door observatie en imitatie van anderen.
- Voorbeeld: Studenten nemen studiemethoden over van succesvolle klasgenoten.

**1.4 Contactconditionering (Zajonc, 1968)**

- Bekendheid met een persoon of object leidt tot een positievere perceptie (mere exposure effect).
- Voorbeeld: Nieuwe collega’s worden sympathieker door herhaalde interacties.

---

### 2. Organisatorische Visies op Leerprocessen

**2.1 Leercyclus van Kolb**

- Leren is een dynamisch en continu proces met vier fasen:
    1. **Ervaring opdoen (Doener)**
    2. **Reflecteren (Beschouwer)**
    3. **Theorie vormen (Denker)**
    4. **Toepassen in de praktijk (Beslisser)**
- Verschillende leerstijlen: Beschouwers, Denkers, Doeners en Beslissers.
- Kritiek: Model is te lineair en heeft onvoldoende empirische onderbouwing, maar blijft populair in trainingen.

**2.2 SECI-model (Nonaka & Takeuchi, 1995)**

- Leren binnen organisaties door interactie tussen **impliciete** (persoonlijke, onbewuste) en **expliciete** (formele, overdraagbare) kennis.
- Vier vormen van kennisconversie:
    1. **Socialisatie** (impliciet → impliciet) → Kennis delen door samenwerking.
    2. **Externalisatie** (impliciet → expliciet) → Persoonlijke kennis expliciet maken.
    3. **Combinatie** (expliciet → expliciet) → Bestaande kennis combineren.
    4. **Internalisatie** (expliciet → impliciet) → Theorieën omzetten in praktijk.
- Organisaties leren door continue interactie tussen deze kennisvormen.

---

### 3. Kunnen Organisaties Leren? (Peter Senge, 1995)

- Organisaties leren niet zelf, maar hun medewerkers wél.
- Lerende organisaties passen zich continu aan veranderende omstandigheden aan.
- Organisatorische cultuur is een cruciale voorwaarde voor leren.
- **Concurrentievoordeel**: Hoe beter een organisatie leert, hoe beter ze zich aanpast aan een veranderende kennismaatschappij.

# Module 04: Fundamenten van Groepsgedrag

---

### 1. Wat is een groep?

- Een groep bestaat als er:
    1. Een **gezamenlijk doel** is.
    2. **Collectieve normen** worden gehanteerd.
    3. Een **groepsidentiteit** aanwezig is.
- **Soorten groepen**:
    - **Formele groepen** (bv. taakgroepen, bevelgroepen).
    - **Informele groepen** (bv. vriendengroepen, belangengroepen).

---

### 2. Groepsformatie

- **Tuckman’s 5 fasen van groepsvorming**:
    1. **Forming** – Oriëntatiefase, kennismaken.
    2. **Storming** – Conflictfase, machtsstrijd.
    3. **Norming** – Stabilisatie, groepsnormen vormen zich.
    4. **Performing** – Productieve fase, samenwerken loopt goed.
    5. **Adjourning** – Afronding en uiteengaan (bij tijdelijke groepen).

---

### 3. Groepsrollen en groepsnormen

#### Groepsrollen

- Rollen kunnen spontaan ontstaan of toegewezen worden.
- **Belangrijke rolconcepten**:
    - **Rolambiguïteit** – Onduidelijkheid over verwachtingen.
    - **Rolverwachting vs. rolperceptie** – Wat verwacht wordt versus hoe iemand het ziet.
    - **Rolconflict** – Botsende verwachtingen binnen een rol.
    - **Status** – Belang van sociale positie in de groep.

#### Groepsnormen

- **Delen van gedragsregels binnen een groep**, zoals:
    
    - Hoe hard er gewerkt moet worden.
    - Wat geaccepteerd wordt in interacties met de leidinggevende.
    - Hoe men omgaat met collega’s en klanten.
- **Totstandkoming groepsnormen**:
    
    1. **Door statements van leiders of leden** (“hier drinken we geen alcohol”).
    2. **Door kritische incidenten** (bv. iemand verlaat de groep na een belediging).
    3. **Eerste gedragingen zetten de toon** (bv. aanspreken met achternaam).
    4. **Overdracht uit een andere groep** (bv. gewoontes overnemen van een eerdere werkplek).
- **Effecten van groepsnormen**:
    
    - **Hawthorne-effect**: Wanneer mensen zich speciaal voelen binnen een groep, beïnvloedt dit hun gedrag positief.
    - Organisaties kunnen moeite hebben om diepgewortelde groepsnormen te veranderen.

---

### 4. Kansen en bedreigingen van groepen

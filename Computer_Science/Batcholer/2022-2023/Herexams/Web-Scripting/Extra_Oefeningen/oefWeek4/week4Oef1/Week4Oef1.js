...
//onderstaande iteratie zorgt voor de creatie van de titels van de eerste rij.
...
//onderstaande iteratie bouwt de data afkomstig van de array op in de tabel
for (itemMoun of MOUNTAINS) {
    ...
    //td_tag_body.style.textAlign = "right";
    td_tag_body.className = "rechts";
...
//de opgebouwde html tabel wordt nu in de boomstructuur gekoppeld aan de output tag.

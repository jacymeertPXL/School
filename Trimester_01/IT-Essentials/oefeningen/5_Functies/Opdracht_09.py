...
def reiskosten(stad, aantal_dagen):
    totale_prijs = hotel_kosten(aantal_dagen - 1) + vliegtuig_kosten(stad) + huurauto_kosten(aantal_dagen)
    return totale_prijs

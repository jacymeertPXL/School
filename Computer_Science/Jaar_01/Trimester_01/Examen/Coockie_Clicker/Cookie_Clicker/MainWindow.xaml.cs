...
namespace Coockie_Clicker
{
    ...
    public partial class MainWindow : Window
    {
        ...
        // Variable
        private double Score, Income, Clicked, Bought, Used, goldencookie, AantalAchienvments, Tijd;
        ...
        /// </summary>
        private DispatcherTimer ProgrammeTimer;
        ...
        public MainWindow()
        {
            ...
            // Timer Tick voor Tijd Tracking
            ProgrammeTimer = new DispatcherTimer();
            goldenCookieTimer.Interval = TimeSpan.FromSeconds(1);

            goldenCookieTimer.Tick += ProgrammeTimer_Tick;
            goldenCookieTimer.Start();
        }
        ...
        private void ProgrammeTimer_Tick(object sender, EventArgs e)
        {
            Tijd++;
        }
        ...
        {
            MessageBox.Show("Er wordt op het moment zoveel verdient " + (0.001 * CursorClass.Gekocht) +
                "Je hebt zoveel van deze inverstering gekocht " + CursorClass.Gekocht +
                "De bonus zou dit verhogen met 100 procent" +
                "En deze inverstering maakt u een passief income per koop van 0.001 per 10 milseconden");
        }

        private void BtnGrandma_ToolTipOpening(object sender, ToolTipEventArgs e)
        {
            MessageBox.Show("Er wordt op het moment zoveel verdient " + (0.01 * GrandmaClass.Gekocht) +
                "Je hebt zoveel van deze inverstering gekocht " + GrandmaClass.Gekocht +
                "De bonus zou dit verhogen met 100 procent" +
                "En deze inverstering maakt u een passief income per koop van 0.01 per 10 milseconden");
        }

        private void BtnFarm_ToolTipOpening(object sender, ToolTipEventArgs e)
        {
            MessageBox.Show("Er wordt op het moment zoveel verdient " + (0.08 * FarmClass.Gekocht) +
                "Je hebt zoveel van deze inverstering gekocht " + FarmClass.Gekocht +
                "De bonus zou dit verhogen met 100 procent" +
                "En deze inverstering maakt u een passief income per koop van 0.08 per 10 milseconden");
        }

        private void BtnMine_ToolTipOpening(object sender, ToolTipEventArgs e)
        {
            MessageBox.Show("Er wordt op het moment zoveel verdient " + (0.47 * MineClass.Gekocht) +
                "Je hebt zoveel van deze inverstering gekocht " + MineClass.Gekocht +
                "De bonus zou dit verhogen met 100 procent" +
                "En deze inverstering maakt u een passief income per koop van 0.47 per 10 milseconden");
        }

        private void BtnFactory_ToolTipOpening(object sender, ToolTipEventArgs e)
        {
            MessageBox.Show("Er wordt op het moment zoveel verdient " + (2.60 * FactoryClass.Gekocht) +
                "Je hebt zoveel van deze inverstering gekocht " + FactoryClass.Gekocht +
                "De bonus zou dit verhogen met 100 procent" +
                "En deze inverstering maakt u een passief income per koop van 2.60 per 10 milseconden");
        }

        private void BtnBank_ToolTipOpening(object sender, ToolTipEventArgs e)
        {
            MessageBox.Show("Er wordt op het moment zoveel verdient " + (14 * BankClass.Gekocht) +
                "Je hebt zoveel van deze inverstering gekocht " + BankClass.Gekocht +
                "De bonus zou dit verhogen met 100 procent" +
                "En deze inverstering maakt u een passief income per koop van 14 per 10 milseconden");
        }

        private void BtnTemple_ToolTipOpening(object sender, ToolTipEventArgs e)
        {
            MessageBox.Show("Er wordt op het moment zoveel verdient " + (78 * TempleClass.Gekocht) +
                "Je hebt zoveel van deze inverstering gekocht " + TempleClass.Gekocht +
                "De bonus zou dit verhogen met 100 procent" +
                "En deze inverstering maakt u een passief income per koop van 78 per 10 milseconden");
        }
        ...
        private void Btn_Statieken_Click(object sender, RoutedEventArgs e)
        {
            MessageBox.Show("Je hebt momenteel " + Score + " Cookies"
                + "Zoveel is het passieve incomen tot nu toe " + (Clicked - Score) + 
                " Zoveel seconden heb ge ge spendeert in het programma " + Tijd + 
                " Zovaak heb jij zelf op de knop geclicked " + Clicked + 
                " Op dit moment hebt u ook zovaak al op de golden cookie geclikced " + goldencookie +
                " En je hebt al zoveel quest gedaan tot nu toe " + AantalAchienvments);
        }

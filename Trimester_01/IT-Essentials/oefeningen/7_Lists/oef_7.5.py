...
def main():
    ...
    tellers = [0] * 5  # lijst met 4 tellers om de stemmen van elke code te tellen (1-4)
    # + de lege string om zo positie 1 aan code 1 te gegeven (positie 0 is de lege string)
